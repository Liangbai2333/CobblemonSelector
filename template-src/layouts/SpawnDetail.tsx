...
// @ts-ignore
import {SpawnCondition, SpawnDetail} from "../types/Pokemon.type.ts";
...
function SpawnDetailInfo({detail}: { detail: SpawnDetail }) {
                    ...
                    <>
                        ...
                        <div>
                            ...
                            <div className="mx-auto mt-4 text-sm">
                                <ConditionContainer>
                                    <div
                                        className="text-lg text-green-600 font-bold">倍率: {weightMultiplier.multiplier}x
                                    </div>
...
export default function SpawnDetail() {
    ...
    const details = index >= 0 ? [pokemon?.spawn_details?.[index]!!] : pokemon?.spawn_details
            ...
            {pokemon && details && (
                <PokeCard>
                    ...
                    {details.map((detail, index) => (
                        <>
                            <SpawnDetailInfo key={index} detail={detail}/>
                            {index < details.length - 1 && <div className="h-6 mt-5 w-full bg-gray-300"></div>}
                        </>
                    ))}
